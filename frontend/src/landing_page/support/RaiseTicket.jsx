      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-14 gap-x-10">
        ...
        <div className="space-y-4">
          <h4 className="text-2xl font-medium text-gray-800 flex items-center gap-3">
            <AddCircleIcon className="text-blue-600 hover:text-blue-700 cursor-pointer transition-colors" />{" "}
            Account Opening
          </h4>
          ...
          <div className="flex flex-col ml-1.5">
            <a
              href=""
              className="text-blue-600 hover:text-blue-700 leading-10 transition"
            >
